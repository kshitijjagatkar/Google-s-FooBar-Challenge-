...
If you wanna directly jump to the code then go ahead I have also provided the docstring for detailed explanation and guidence.
...
there are two files provided, one is python and another one is jupyter notebook file.
